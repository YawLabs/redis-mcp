...
# by hand when someone remembered (0.3.5) and not at all otherwise, and step 6
# took the GitHub release notes from commit subjects regardless, so 0.4.0
# shipped with no changelog entry and a subject-list release page -- one of ten
# versions across this fleet on 2026-09-13 with the same shape.
#
